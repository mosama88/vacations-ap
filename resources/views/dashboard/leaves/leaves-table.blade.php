        ...
        <div class="row col-12 my-2">
            ...
            <div class="form-group col-4">
                <div class="form-group col-4" id="employee_div">
                    ...
                    <input type="text" wire:model.live="emp_search" class="form-control bg-white"
                        id="exampleInputemployee_id" placeholder="">
                </div>
                ...
                <div class="form-group col-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="start_date" wire:model.live="start_date_search"
                ...
                <div class="form-group col-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                        <input type="text" id="end_date" wire:model.live="end_date_search" class="form-control"
                    ...
                    <div class="form-group col-12">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customPending"
                                wire:model.live="leave_status_search" value="{{ LeaveStatusEnum::Pending }}">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customApproved"
                                wire:model.live="leave_status" value="{{ LeaveStatusEnum::Approved }}">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRefused"
                                wire:model.live="leave_status" value="{{ LeaveStatusEnum::Refused }}">
